...
class PmbNonRegFakultasChart extends StatefulWidget {
  const PmbNonRegFakultasChart({super.key});

  @override
  State<PmbNonRegFakultasChart> createState() => _PmbRegFakultasChartState();
}

class _PmbRegFakultasChartState extends State<PmbNonRegFakultasChart> {
  @override
      ...
      children: [
        SizedBox(
          ...
          child: BlocBuilder<AkademikCubit, AkademikState>(
            bloc: akademikCubit..getPmbNonRegulerFakultas(),
