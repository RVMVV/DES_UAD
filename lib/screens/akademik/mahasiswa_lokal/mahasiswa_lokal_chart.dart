...
import 'mahasiswa_lokal_fakultas_chart.dart';
import 'mahasiswa_lokal_prodi_chart.dart';

class MhsLokalChart extends StatefulWidget {
  final String title;
  const MhsLokalChart({
    required this.title,
    super.key,
  ...
  @override
  State<MhsLokalChart> createState() => _MhsLokalChartState();
}

class _MhsLokalChartState extends State<MhsLokalChart> {
